...
// Make sure to do this using the rest and spread operator.Write a function called findMin that accepts a variable number of arguments
...
// mergeObjects
// Write a function called mergeObjects that accepts two objects and returns a new object which contains all the keys and values of the
...
const removeRandomElement = items => {
...
const modifiedKeyAndValue = (object, key, value) =>{
    let newObject = {...object}
    newObject[key] = value;
    return newObject
}